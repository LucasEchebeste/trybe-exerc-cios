function createDaysOfTheWeek() {
  ...
  //Exercício Parte 1 - Desenvolva uma função que crie dinamicamente cada dia do calendário e os adicione dentro da tag <ul> com id "days".
...
function criaDiasDoMes () {
    let minhaLista = document.querySelector('#days');
    for (let i = 0; i < decemberDaysList.length ; i += 1) {
        let dias = decemberDaysList[i];
